...
type ExampleValue = string | number | boolean | null | Record<string, unknown> | unknown[];
...
function generateObjectExample(schema: z.ZodObject<z.ZodRawShape>): Record<string, unknown> {
